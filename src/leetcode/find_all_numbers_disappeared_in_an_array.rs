...
//     println!("This is Solution 1 : Output 1 {:?}", solution_1(&mut input_1));
//     println!("This is Solution 1 : Output 2 {:?}", solution_1(&mut input_2));
//     println!("This is Solution 1 : Output 3 {:?}", solution_1(&mut input_3));
